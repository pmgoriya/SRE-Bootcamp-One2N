...
{{ include "secrets-bridge.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "secrets-bridge.selectorLabels" -}}
...
*/}}
{{- define "secrets-bridge.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "secrets-bridge.fullname" .) .Values.serviceAccount.name }}
{{- else }}
